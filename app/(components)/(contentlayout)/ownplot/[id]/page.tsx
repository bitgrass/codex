...
const tabData = [
  {
    id: "standard",
    title: "Bitgrass Landplot Collection – Standard 100m² Plot",
    description: "Discover the Bitgrass Standard 100m² Landplot, a tokenized land plot offering carbon credit rights and staking benefits.",
  ...
  {
    id: "premium",
    title: "Bitgrass Landplot Collection – Premium 500m² Plot",
    description: "Explore the Bitgrass Premium 500m² Landplot, a tokenized land plot with enhanced carbon credit potential and staking rewards.",
  ...
  {
    id: "legendary",
    title: "Bitgrass Landplot Collection – Legendary 1000m² Plot",
    description: "Own a Bitgrass Legendary 1000m² Landplot, a premium tokenized land plot with high carbon credit potential and exclusive benefits.",
...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  if (!tab) {
    return {
      title: "Bitgrass Landplot Collection",
      description: "Discover Bitgrass Landplot Collections, tokenized land plots with carbon credit utilities.",
    };
  }
      ...
      images: [
        {
          ...
          width: 800,
          height: 600,
          alt: `Bitgrass ${tab.id.charAt(0).toUpperCase() + tab.id.slice(1)} Landplot`,
        },
      ],
      url: `${baseUrl}/${tab.id}`,
      type: "website",
